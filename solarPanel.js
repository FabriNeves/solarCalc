class PainelSolar {
    ...
    calculaPotSaidaInversor(potCorrigida, rendimentoInversor, qtdPaineis) {
        ...
        const potRendimentoInversor = potCorrigida * (1 - (1 - rendimentoInversor / 100)).toFixed(3);
...
// const potCorrigida = painel270w.calcularPotenciaCorrigida(26);
// const rendimentoInversor = inversor4.getEficiencia();

// const potSaidaInversor = painel270w.calculaPotSaidaInversor(potCorrigida, rendimentoInversor,15);

// const pot = potSaidaInversor;

// console.log(pot);

// console.log(painel270w.calculoEnergiaGeradaMensal(31,6,0.98,pot) + " kWh")